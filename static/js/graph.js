...
function makeGraphs(error, tweetsJson) {
	...
	profileimage.src = all_tweets[0].user.profile_image_url.replace('_normal', '_400x400');
	document.getElementById('profile-image').appendChild(profileimage);
	profileimage.classList.add("rounded-circle", "profile-img", "mx-auto", "d-block");
